...
Статьи энциклопедии содержат ссылки в теле Content на другие релевантные для рассматриваемой темы статьи. Сбор датасета для проводился методом парсинга с использованием библиотеки Beautiful Soup Python, файл исходного кода приложен в датасет. Визуализация осуществлялась при помощи ??? 
