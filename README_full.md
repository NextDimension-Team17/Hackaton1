...
Сбор датасета для проводился методом парсинга ссылок в теле Content текущей статьи на другие релевантные для рассматриваемой теме статьи. Парвсинг осуществлялся с использованием библиотеки Beautiful Soup Python. Файл исходного кода приложен в датасет. Визуализация осуществлялась при помощи ???
